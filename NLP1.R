...
# -----------------------------------------------------------------------------------
# 7? Step - Only 2 attributes are used.
...
# -----------------------------------------------------------------------------------
# 9? Step -  Tokenization - We need to both break the text into individual tokens.
...
# -----------------------------------------------------------------------------------
# 10? Step - Stemming Words - After tokenization, we need to analyze each word by 
...
# -----------------------------------------------------------------------------------
# 12? Step - We can find the most common words in all the reviews as a whole and 
...
# -----------------------------------------------------------------------------------
# 13? Step - Sentiment Analysis - We can use the tools of text mining to approach the
...
# -----------------------------------------------------------------------------------
# 14? Step - Most Common Positive and Negative Words.
...
# -----------------------------------------------------------------------------------
# 15? Step - Words with the greast contributions to positive/negative sentiment
...
# -----------------------------------------------------------------------------------
# 17? Step - tf-idf - The statistic tf-idf is intended to mesure how important a word
